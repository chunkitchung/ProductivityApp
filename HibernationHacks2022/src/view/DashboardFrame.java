...
public class DashboardFrame extends JFrame {
	...
	private Image img_logo= new ImageIcon(DashboardFrame.class.getResource("logo.jpg")).getImage().getScaledInstance(90,90,Image.SCALE_SMOOTH);
	private Image img_logoHome= new ImageIcon(DashboardFrame.class.getResource("Home.png")).getImage().getScaledInstance(40,40,Image.SCALE_SMOOTH);
	private Image img_logoCal= new ImageIcon(DashboardFrame.class.getResource("Calendar.png")).getImage().getScaledInstance(40,40,Image.SCALE_SMOOTH);
	private Image img_logoPom= new ImageIcon(DashboardFrame.class.getResource("Pomodoro.png")).getImage().getScaledInstance(40,40,Image.SCALE_SMOOTH);
	private Image img_logoTasks= new ImageIcon(DashboardFrame.class.getResource("Tasks.png")).getImage().getScaledInstance(40,40,Image.SCALE_SMOOTH);
